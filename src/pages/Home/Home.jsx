          ...
          <section className="product-list">
            ...
            <div className="product-box">
              ...
              <div>
                ...
                <pre>Cena: 1399zł</pre>
                <p>
Poznaj bardziej smukłe, mniejsze PS4, które
                  oferuje graczom niesamowite wrażenia z gier.
            ...
            <div className="product-box">
              ...
              <div>
                ...
                <pre>Cena: 1500zł</pre>
                <p>
Na Xbox One X gra się jeszcze lepiej. Dzięki większej
                  o 40% mocy niż na jakiejkolwiek innej konsoli.
            ...
            <div className="product-box">
              ...
              <div>
                ...
                <p>
                  MacBook Pro - dotyk czyni cuda Jest niewiarygodnie
                  smukły, lekki jak piórko, a do tego potężniejszy i
            ...
            <div className="product-box">
              ...
              <div>
                ...
                <pre>Cena: 3600zł</pre>
                <p>
11-calowy MacBook Air działa bez ładowania
                  baterii do 9 godzin, a 13-calowy - nawet 12.
            ...
            <div className="product-box">
              ...
              <div>
                ...
                <pre>Cena: 7299zł</pre>
                <p>
iPhone X to telefon, który nie tyle posiada ekran,
                  ile po prostu sam tym ekranem jest.
                </p>
